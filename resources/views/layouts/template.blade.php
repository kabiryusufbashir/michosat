...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div id="navDesktop" class="z-40 fixed bg-blue-900 w-full lg:grid grid-cols-5 gap-3 shadow lg:px-24 px-8 py-4 flex justify-between items-center">
                ...
                <div class="">
                    <a href="/">
                        <div class="lg:col-span-1">
                            <img class="w-14 lg:w-16 lg:ml-0" src="{{ asset('images/micohsat.png') }}" alt="MICOHSAT Logo">
                        </div>
                    </a>
                </div>
            </div>
            <div class="lg:col-span-4 hidden lg:block">
                <nav class="lg:flex justify-between list-none uppercase font-medium items-center">
                    ...
                    <li class="py-1 hover:text-green-600 text-white dropdown relative">
                    ...
                    <li class="py-1 hover:text-green-600 text-white"><a href="#">Board of Trustees</a></li>
                    <li class="py-1 hover:text-green-600 text-white"><a href="/future-projects">Future Projects</a></li>
                    <li class="py-1 hover:text-green-600 text-white"><a href="/contact">Contact Us</a></li>
                </nav>
            </div>
        </div>
        <!-- Mobile Nav -->
        ...
        <div class="relative top-12">
            <div id="footer" class="bg-blue-900 py-12 px-8 lg:px-24 lg:grid grid-cols-5 gap-8 text-white">
            ...
            <div class="py-7 text-center text-xs bg-blue-700 text-white">
                <footer>
